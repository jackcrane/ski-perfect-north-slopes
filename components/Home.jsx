...
const Home = (props) => {
  ...
  return (
    <>
      ...
      <View style={{backgroundColor: `rgba(255,255,255,${scrollPosition / 50})`, height: 45, position: 'absolute', zIndex:4, top: 0, left: 0, width: '100%'}}></View>
      <ScrollView 
        ...
        <View style={styles.menuRight}>
          <TouchableOpacity onPress={() => props.nav.navigate('Snow Report')}>
            <Icon name="snow-outline" style={{...styles.menuIcon, fontSize: 40}}></Icon>
          </TouchableOpacity>
        </View>
        <View style={styles.homeContainer}>
          <Image source={require('../assets/hero.jpg')} style={{height: (400 - (scrollPosition * 1)),...styles.heroImage}} />
          <Image source={require('../assets/pns-logo.png')} style={styles.logo} />
